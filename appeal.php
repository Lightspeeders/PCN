...
<html lang="en">
    <head>
        ...
        <title>PCN Online Appeal Service</title>
                ...
                <div class="form-container z-depth-5">
                    ...
                    <div class="row">
                        <form class="col s12" id="reused_form">
							...
							<div class="row">
                                <div class="input-field col s12">
                                    <input id="reg" type="text" name="reg" required class="validate">
                                    <label for="reg">Registration Number</label>
                                </div>
                            </div>
							<div class="row">
                                <div class="input-field col s12">
                                    <input id="ref" type="text" name="ref" required class="validate">
							...
							<div class="row">
                                <div class="input-field col s12">
                                    ...
                                    <label for="message">Reason for Appeal</label>
                                </div>
                            </div>
                            <div>
                                <button class="waves-effect waves-light btn submitbtn" type="submit">Appeal Now</button>
                            </div>
                        </form>
                        <div id="error_message" style="width:100%; height:100%; display:none; ">
                            ...
                            Sorry there was an error sending your appeal. 
                        </div>
                        <div id="success_message" style="width:100%; height:100%; display:none; ">
                            <h4>
                                Success! Your appeal was submitted successfully.
                            </h4>
                        </div>
                    </div>
                </div>
